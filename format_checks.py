            ...
            if "§§" in line:
                ...
                if invalid_multiple_pattern.search(line):
                    ...
                    issues.append(
                        {
                            "message": (
                                f"Incorrect multiple section symbol usage in line {i} - "
                                f"use single § for multiple sections"
                            ),
